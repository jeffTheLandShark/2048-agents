"""
Log Processing Utility for 2048 Analysis.

This script converts raw JSONL (JSON Lines) log files generated by experiments into
Parquet files. Parquet is a columnar storage format that is much more efficient for
statistical analysis and data loading in tools like pandas or typical data science workflows.
